...
Route::get('jobs/{job}/invoices/{invoice}/send/{details}', 'JobInvoicesController@send')->name('jobs.invoices.send');
...
Route::post('jobs/{job}/invoices/{invoice}/print', 'JobInvoicesController@print')->name('jobs.invoices.print');
